...
// Explicitly require drivers for Vercel bundler (ncc)
try {
    require('pg');
    require('pg-hstore');
} catch (e) {
    // Ignore, these should be in package.json
}
...
const sequelize = process.env.DATABASE_URL
    ...
    : new Sequelize({
        dialect: 'sqlite',
        storage: '/tmp/database.sqlite' // Use /tmp for writable filesystem on Vercel
    });
